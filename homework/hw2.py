...
print("Степень math:", result_m_exp)
...
print("Квадратный корень из", item_2, "равен:", result_s_root)
...
print("math Квадратный корень из", item_2, "равен:", result_m_s_root)
...
print("math pow Квадратный корень из", item_2, "равен:", result_mp_s_root)
...
print("Округление в меньшую сторону:", result_m_floor)
...
print("Округление в большую сторону:", result_m_ceil)
...
print("Округление через приведение:", result_int)
...
print("Сложение с присвоением:", item_3)
#
...
print("Возведение в степень с присвоением:", item_3)
...
print("Корень с присвоением:", item_3)
...
print("Остаток от деления с присвоением:", item_3)
...
print("Разница:", b_item_relult_subtr)
...
print("Умножение:", b_item_relult_multi)

#  56 и 57. Вывести b_item_relult_division в консоль. (Получить ошибку)
try:
...
print("Явное присвоение к int = ", b_item_1_int)
...
print("False к int = ", b_item_2_int)
